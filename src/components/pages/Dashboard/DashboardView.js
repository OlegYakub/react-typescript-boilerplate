...
import {DISCUSSION_BOARD, LIBRARY, REFER_FRIEND, PORTFOLIO} from "../../../navigation/routes";
...
class DashboardView extends React.Component {
  ...
  render() {
    const {libraryData, hotDiscussions} = this.props;
    return (
                ...
                <div className={styles.infoBlocks}>
                  ...
                  <div className={styles.infoBlocksItem}>
                    <div className={`${styles.infoBlock} ${styles.infoBlockValue}`}>
                      <span className={styles.infoBlockData}>$900.00</span>
